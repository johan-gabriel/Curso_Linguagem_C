...
int main(){
    ...
    if (arq)
    {
        ...
        // no caso estamos varrendo char por char e escrevendos na tela
        //                        EOF = uma macro que define o limite do arquivo
        //                        quando o arquivo acaba ele tem uma macro de sinalização.
